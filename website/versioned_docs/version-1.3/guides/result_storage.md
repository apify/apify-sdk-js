---
id_old: version-1.3-result-storage
...
In the Apify SDK, the dataset is represented by the [`Dataset`](../api/Dataset.md) class. In order to simplify writes to the default dataset, the SDK
