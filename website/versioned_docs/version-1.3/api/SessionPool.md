---
id_old: version-1.3-session-pool
title: SessionPool
id: session-pool
---
...
Handles the rotation, creation and persistence of user-like sessions. Creates a pool of [`Session`](Session.md) instances, that are randomly
