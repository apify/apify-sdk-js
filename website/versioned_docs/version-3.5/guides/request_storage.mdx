...
To see more detailed example of how to use the request queue with a crawler, see the [Puppeteer Crawler](../examples/puppeteer-crawler) example.
...
In Apify SDK, the request list is represented by the <CrawleeApiLink to="core/class/RequestList">`RequestList`</CrawleeApiLink> class.
...
To see more detailed example of how to use the request list with a crawler, see the [Puppeteer with proxy](../examples/puppeteer-with-proxy) example.
