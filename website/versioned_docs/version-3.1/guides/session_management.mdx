...
<CrawleeApiLink to="core/class/SessionPool">`SessionPool`</CrawleeApiLink> is a
class that allows you to handle the rotation of proxy IP addresses along with
cookies and other custom settings in Apify SDK.
...
**Example usage in <CrawleeApiLink to="puppeteer-crawler/class/PuppeteerCrawler">`PuppeteerCrawler`</CrawleeApiLink>**
...
**Example usage in <CrawleeApiLink to="cheerio-crawler/class/CheerioCrawler">`CheerioCrawler`</CrawleeApiLink>**
...
**Example usage in <CrawleeApiLink to="basic-crawler/class/BasicCrawler">`BasicCrawler`</CrawleeApiLink>**
