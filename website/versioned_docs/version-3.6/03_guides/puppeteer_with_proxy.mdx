...
To make it work, you'll need an Apify account with access to the proxy. Visit the [Apify platform introduction](../concepts/actor-lifecycle) to find how to log into your account from the SDK.
