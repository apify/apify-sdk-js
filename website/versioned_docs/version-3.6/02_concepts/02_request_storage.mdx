...
To see more detailed example of how to use the request queue with a crawler, see the [Puppeteer Crawler](../guides/puppeteer-crawler) example.
...
To see more detailed example of how to use the request list with a crawler, see the [Puppeteer with proxy](../guides/puppeteer-with-proxy) example.
