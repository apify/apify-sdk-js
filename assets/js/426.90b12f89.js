...
function mapToAlgoliaResponse_typeof(obj) { "@babel/helpers - typeof"; return mapToAlgoliaResponse_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, mapToAlgoliaResponse_typeof(obj); }
...
function mapToAlgoliaResponse_defineProperty(obj, key, value) { key = mapToAlgoliaResponse_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function mapToAlgoliaResponse_toPropertyKey(arg) { var key = mapToAlgoliaResponse_toPrimitive(arg, "string"); return mapToAlgoliaResponse_typeof(key) === "symbol" ? key : String(key); }
function mapToAlgoliaResponse_toPrimitive(input, hint) { if (mapToAlgoliaResponse_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (mapToAlgoliaResponse_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
const algoliasearch_lite_esm_browser_version = '4.17.2';
