...
const introduction = readFileSync(
    path.join(docPath, 'readme', 'introduction.md'),
    'utf8',
);
const motivation = readFileSync(
    path.join(docPath, 'guides', 'motivation.md'),
    'utf8',
);
const overview = readFileSync(
    path.join(docPath, 'readme', 'overview.md'),
    'utf8',
);
const gettingStarted = readFileSync(
    path.join(docPath, 'guides', 'quick_start.md'),
    'utf8',
);
const support = readFileSync(
    path.join(docPath, 'readme', 'support.md'),
    'utf8',
);
...
const fixHeaders = (doc) =>
    doc.replace(hashRx, hashReplace).replace(headerRx, headerReplace);
