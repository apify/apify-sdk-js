...
You can also develop your actor in an online code editor directly on the platform (you'll need an Apify account). Let's go to the [Actors](https://console.apify.com/actors) page in the app, click **Develop new**, choose a template, go to the **Source** tab and start writing the code or paste one of the examples from the [Examples](../03_guides) section.
