...
To avoid this, you should check the `eventChargeLimitReached` field in the result returned by `Actor.charge` or `Actor.pushData` and stop your Actor when the limit is reached:
